...
const topics = () => {
    ...
    const topicLesson = [
        { title: 'SELECT', state: 'Not Started' },
        { title: 'JOIN', state: 'In Progress' },
        { title: 'GROUP BY', state: 'Completed' },
        { title: 'ORDER BY', state: 'Not Started' },
        { title: 'WHERE', state: 'Not Started' },
        { title: 'HAVING', state: 'Not Started' },
        { title: 'INSERT', state: 'Not Started' },
        { title: 'UPDATE', state: 'Not Started' },
        { title: 'DELETE', state: 'Not Started' },
        { title: 'Indexes', state: 'Not Started' },
        { title: 'Subqueries', state: 'Not Started' },
    ];
                    ...
                    <div className='flex justify-between items-center mb-4'>
                        <div className='flex items-center gap-4'>
                            <div className='flex p-3 bg-purple-100 dark:bg-purple-900 rounded-xl shrink-0'>
                                <SiMysql className='h-7 w-7 text-purple-700 dark:text-purple-300' />
                            </div>
