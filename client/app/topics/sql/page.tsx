...
const LESSON_KEY = "mysql-topic-progress";
const NOTES_KEY = "mysql-lesson-notes";

const Topics = () => {
    const defaultLessons: Lesson[] = [
        { title: "SELECT", state: 0 },
        { title: "JOIN", state: 0 },
        { title: "GROUP BY", state: 0 },
        { title: "ORDER BY", state: 0 },
        { title: "WHERE", state: 0 },
        { title: "HAVING", state: 0 },
        { title: "INSERT", state: 0 },
        { title: "UPDATE", state: 0 },
        { title: "DELETE", state: 0 },
        { title: "Indexes", state: 0 },
        { title: "Subqueries", state: 0 },
    ];
