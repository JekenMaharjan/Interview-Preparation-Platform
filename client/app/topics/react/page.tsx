...
const topics = () => {
    ...
    const topicLesson = [
        {title: 'useState Hook', state: 'Not Started'},
        {title: 'useEffect Hook', state: 'In Progress'},
        {title: 'Props', state: 'Completed'},
        {title: 'State Lifting', state: 'Not Started'},
        {title: 'Context API', state: 'Not Started'},
        {title: 'Context API', state: 'Not Started'},
        {title: 'React Router', state: 'Not Started'},
        {title: 'Conditional Rendering', state: 'Not Started'}
    ];
