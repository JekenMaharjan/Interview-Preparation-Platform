...
const topics = () => {
    ...
    const topicLesson = [
        { title: 'Array methods', state: 'Not Started' },
        { title: 'Closures', state: 'In Progress' },
        { title: 'Promises', state: 'Completed' },
        { title: 'Async/Await', state: 'Not Started' },
        { title: 'Event loop', state: 'Not Started' },
        { title: 'Hoisting', state: 'Not Started' },
        { title: 'ES6 Modules', state: 'Not Started' },
        { title: 'Destructuring', state: 'Not Started' },
        { title: 'Spread & Rest', state: 'Not Started' },
        { title: 'Call, Apply, Bind', state: 'Not Started' },
        { title: 'Object manipulation', state: 'Not Started' }
    ];
