...
const topics = () => {
    ...
    const topicLesson = [
        { title: 'REST APIs', state: 'Not Started' },
        { title: 'Scalability basics', state: 'In Progress' },
        { title: 'Load Balancing', state: 'Completed' },
        { title: 'Caching strategies', state: 'Not Started' },
        { title: 'Database design', state: 'Not Started' },
        { title: 'Microservices', state: 'Not Started' },
        { title: 'Rate limiting', state: 'Not Started' },
        { title: 'Data partitioning', state: 'Not Started' },
        { title: 'Message Queues', state: 'Not Started' },
        { title: 'CAP theorem', state: 'Not Started' },
        { title: 'High availability', state: 'Not Started' },
    ];
                    ...
                    <div className='flex justify-between items-center mb-4'>
                        <div className='flex items-center gap-4'>
                            <div className='flex p-3 bg-purple-100 dark:bg-purple-900 rounded-xl shrink-0'>
                                <SiMaterialdesignicons className='h-7 w-7 text-purple-700 dark:text-purple-300' />
                            </div>
